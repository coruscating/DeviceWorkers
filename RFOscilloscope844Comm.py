...
class Comm:
    def __init__(self):  
        try:
            ...
            self.internal_state["CH1MEAN"] = 0.0
            self.internal_state["CH2MEAN"] = 0.0
    ...
    def read_from_device(self,length=9000):
        ...
        """
        try:
            rv = os.read(self.dev, length).rstrip()
            return rv     
        except Exception as e:
    ...
    def measure_pkpk(self, channel):
        try:
            ...
            if Qready.rstrip() == '1':
                ...
                raise
            self.internal_state["CH" + str(channel) + "PP"] = float(rv)
        except:
    ...
    def measure_mean(self,channel):
        try:
            ...
            if Qready.rstrip() == '1':
                ...
                raise
            self.internal_state["CH" + str(channel) + "MEAN"] = float(rv)
        except Exception as e:
    ...
    def measure_RF_freq(self):
        try:
            ...
            if Qready.rstrip() == '1':
                ...
                raise
            self.internal_state["RF-Freq"] = float(rv)
        except Exception as e:
    ...
    def measure_reff(self,channel):
        try:
            ...
            if Qready.rstrip() == '1':
                ...
                raise
            self.internal_state["CH" + str(channel) + "REF"] = float(rv)
        except Exception as e:
