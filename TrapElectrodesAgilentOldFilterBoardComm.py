...
class Comm:
    ...
    def E3(self, value):
        try:
            ...
            if DEBUG: print 'APPL ' + channels['E3'][2] + ', ' + str(value) + ', 0.001\n'
    ...
    def E5(self, value):
        try:
            ...
            if DEBUG: print 'APPL ' + channels['E5'][2] + ', ' + str(float(value)) + ', 0.001\n'
    ...
    def E0(self, value):
        try:
            ...
            if DEBUG: print 'APPL ' + channels['E0'][2] + ', ' + str(value) + ', 0.001\n'
    ...
    def GotoVoltages(self):
        try:
            ...
            recv1 = string.split(recv, ',')
            cur={}
            cur["E1"]= -float(recv1[0])
            cur["E4"]= -float(recv1[1])
            cur["GND"]= -float(recv1[2])
            tar=self.internal_state
    ...
    def FindDCVoltages(self):
        try:       
            ...
            if self.internal_state['XYTilt'] == 0:
                ...
                tilt_theta = self.internal_state['XYTilt']
                Axx = Azz*-1.5
                Ayy = -Axx - Azz
